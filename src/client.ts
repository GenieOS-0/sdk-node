...
import type {
  ...
  BrandDetail,
  BrandSummary,
  CreateQrDesignRequest,
  CreateQrDesignResponse,
  CreateShortLinkRequest,
  CreateShortLinkResponse,
  ListUtmSuggestionsResponse,
  ReadLinkAnalyticsRequest,
  ReadLinkAnalyticsResponse,
  RenderQrDesignRequest,
  RenderQrDesignResponse,
  ShortLinkDetail,
  ShortLinkSummary,
  UpdateQrDesignRequest,
  UpdateQrDesignResponse,
  ...
  Sequence,
  SequenceDetail,
  SequenceMutationRequest,
  SequenceRun,
  SequenceRunActionRequest,
...
class SequencesResource {
  ...
  patchGraph(
    keyOrId: string,
    body: SequenceMutationRequest,
    opts: { idempotencyKey?: string } = {},
  ): Promise<{ flow: SequenceDetail; appliedOps: Array<{ summary: string }> }> {
    return this.t.request({
      method: 'PATCH',
  ...
  simulate(
    keyOrId: string,
    body: SequenceSimulationInput,
  ): Promise<SequenceSimulationResult> {
    return this.t
      .request<{ data: SequenceSimulationResult }>({
        method: 'POST',
...
class LinksResource {
  ...
  update(linkId: string, body: UpdateShortLinkRequest): Promise<UpdateShortLinkResponse> {
    return this.t
      .request<{ data: UpdateShortLinkResponse }>({
        method: 'PATCH',
        path: `/v1/links/${encodeURIComponent(linkId)}`,
        body,
      })
  ...
  analytics(opts: ReadLinkAnalyticsRequest): Promise<ReadLinkAnalyticsResponse> {
    return this.t
      .request<{ data: ReadLinkAnalyticsResponse }>({
        method: 'GET',
...
class QrResource {
  ...
  create(
    body: CreateQrDesignRequest,
    opts: { idempotencyKey?: string } = {},
  ): Promise<CreateQrDesignResponse> {
    return this.t
      .request<{ data: CreateQrDesignResponse }>({
        method: 'POST',
        path: '/v1/qr',
        body,
        idempotencyKey: opts.idempotencyKey,
  ...
  update(qrId: string, body: UpdateQrDesignRequest): Promise<UpdateQrDesignResponse> {
    return this.t
      .request<{ data: UpdateQrDesignResponse }>({
        method: 'PATCH',
  ...
  render(qrId: string, body: RenderQrDesignRequest = {}): Promise<RenderQrDesignResponse> {
    return this.t
      .request<{ data: RenderQrDesignResponse }>({
        method: 'POST',
