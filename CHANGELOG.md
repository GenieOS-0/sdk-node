...
- Resources: `workspace`, `templates`, `templates.changeRequests`, `events`, `webhooks`, `audit`, `keys`.
- Webhook signature verification helpers exported from `@mailgenius/sdk/webhooks`.
